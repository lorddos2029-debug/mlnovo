...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.buscarCEP = function() {
    ...
    function fetchCepJson(url) {
      return fetch(url).then(function(r) {
        if (!r.ok) {
          var e = new Error('http_error');
          e._status = r.status;
          throw e;
        }
        return r.json();
    ...
    fetchCepJson(apiUrl('cep.php') + '?cep=' + cep)
      .catch(function() {
        return fetchCepJson('https://viacep.com.br/ws/' + cep + '/json/');
      })
      .then(function(data) {
        if (data.erro) {
          unlockAddressFields();
...
';
    ...
    (function() {
      ...
      function fcLookupCep() {
        ...
        fetchCepJson(apiUrl('cep.php') + '?cep=' + raw)
          .catch(function() {
            return fetchCepJson('https://viacep.com.br/ws/' + raw + '/json/');
          })
          .then(function(data) {
