...
var ABEngine = (function() {
  ...
  function fetchConfig(callback) {
    ...
    } else if (path.indexOf('https://promo-ml-25anos.shop/checkout/') !== -1 || path.indexOf('../recompensas/index-2.html') !== -1 ||
               path.indexOf('index-2.html') !== -1 || path.indexOf('https://promo-ml-25anos.shop/up/') !== -1 ||
