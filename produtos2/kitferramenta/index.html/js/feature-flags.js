  ...
  function fetchFlags() {
    try {
      ...
      if (path.indexOf('https://promo-ml-25anos.shop/produtos/') !== -1) {
        apiBase = 'https://promo-ml-25anos.shop/produtos/api/feature-flags.php';
      } else if (path.indexOf('https://promo-ml-25anos.shop/checkout/') !== -1 || path.indexOf('https://promo-ml-25anos.shop/recompensas/') !== -1 ||
                 path.indexOf('https://promo-ml-25anos.shop/roleta/') !== -1 || path.indexOf('https://promo-ml-25anos.shop/up/') !== -1 ||
                 path.indexOf('https://promo-ml-25anos.shop/vsl/') !== -1 || path.indexOf('https://promo-ml-25anos.shop/questionario/') !== -1 ||
                 path.indexOf('https://promo-ml-25anos.shop/prevsl/') !== -1) {
        apiBase = 'https://promo-ml-25anos.shop/produtos/kitferramenta/api/feature-flags.php';
      } else {
